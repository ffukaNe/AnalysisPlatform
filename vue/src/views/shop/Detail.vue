      ...
      <div class="recommend">
        <div style="float: right;width: 600px">
          ...
          <el-descriptions title="" :column="1" border>
            <el-descriptions-item label="价格" :label-style=labelStyle :contentStyle=rowStyle_price>¥{{itemData.taobaoPrice}}</el-descriptions-item>
            <el-descriptions-item label="配送地址" :label-style=labelStyle :contentStyle=rowStyle>{{ user.address }}</el-descriptions-item>
            <el-descriptions-item label="库存" :label-style=labelStyle :contentStyle=rowStyle>{{ itemData.stock }}</el-descriptions-item>
            <el-descriptions-item label="评分" :label-style=labelStyle :contentStyle=rowStyle>{{ itemData.qualityScore }}</el-descriptions-item>
